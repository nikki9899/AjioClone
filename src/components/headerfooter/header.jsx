...
function Navbar() {
  ...
  return (
    <div className="h-[100px] w-full flex border-t-[3px] border-t-[rgb(47,66,84)] border-solid md:mx-3">
      <div className="h-16 w-1/4 border border-transparent ml-20 md:w-36 ">
        <Link href={"/"}>
          <img
            className="h-full w-35 mt-5 ml-27 md:w-24 h-[50px]"
      ...
      <div className="h-full w-3/5 border border-transparent mx-4">
        <div className=" hidden md:flex h-1/2 w-full border border-transparent flex justify-end space-x-5 items-center hover:cursor-pointer">
          <Link href="/Register">
        ...
        <div className="h-1/2 w-full border border-transparent flex justify-between items-center font-sans text-sm text-gray-600 mt-1">
          ...
          <p className="hidden md:block hover:font-bold hover:cursor-pointer">MEN</p>
          <Link href={"/productpage"}>
            {" "}
            <p className="hidden md:block hover:font-bold hover:cursor-pointer">WOMEN</p>
          </Link>
          <p className="hidden md:block hover:font-bold hover:cursor-pointer">KIDS</p>
          <p className="hidden md:block hover:font-bold hover:cursor-pointer">INDIE</p>
          <p className="hidden md:block hover:font-bold hover:cursor-pointer">
            HOME AND KITCHEN
          </p>
          <input
